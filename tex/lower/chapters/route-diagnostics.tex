...
\MFQLead{多因子与计量}\label{route:multifactor}
...
\MFQLead{时间序列与统计套利}\label{route:stat-arb}
...
\MFQLead{机器学习与 AI Alpha}\label{route:ml-alpha}
...
\MFQLead{衍生品定价与对冲}\label{route:derivatives}
...
\MFQLead{组合与风险}\label{route:portfolio-risk}
...
\MFQLead{高频、微观结构与执行}\label{route:microstructure}
