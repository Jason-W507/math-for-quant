\MFQTransition{Alpha 决策、交易摩擦与应用分析题组}
\begin{enumerate}[leftmargin=*]
  ...
  \item \textbf{研究判断：}审计一个预测优秀但成本后为负、仍宣称可交易的研究报告。
  \item \textbf{开放项目：}结合本章模型，解释预测、成交和成本如何共同决定结果，并说明所用假设。
\end{enumerate}

\subsection*{基础衔接：独立计算}
$a=0.02,b=0.01,c=0.002$ 时买入阈值是多少？
