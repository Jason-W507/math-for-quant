...
运行 \path{notebooks/lower/ch16_derivatives_hedging.ipynb} 重建误差分布；运行 \path{tools/build_reports.py derivatives} 必须与 \path{reports/derivatives-v03-summary.md} 逐字一致。
