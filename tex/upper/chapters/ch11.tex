...
\begin{introduction}
  \input{tex/generated/prerequisites/upper-ch11.tex}
...
\]
它具有缩放性 $(W_{ct})_{t\ge0}\overset d=(\sqrt c\,W_t)_{t\ge0}$；取 $c=4,t=1/4$，两边方差都为 1。Donsker 不变性原理说，若 $(\xi_k)$ 独立同分布、均值为零且方差为 1，令 $S_m=\sum_{k=1}^m\xi_k$，则折线插值
\[
