...
实现账本另取中心化得分 $(1,1,-1,-1)$。带宽为 $1$ 的 Bartlett--HAC 使用
$\hat\gamma_0+2(1-1/2)\hat\gamma_1$；按标签 $(0,0,1,1)$ 聚类时则先求两个簇得分和。HAC 与簇稳健标准误分别为 $0.559017$ 与 $0.707107$。这里真方差公式是理论 oracle，固定得分公式检验协方差实现；两者职责不同。
