...
from m4q.lower.time_boundaries import validate_chronological_split, validate_fit_cutoff
from m4q.lower.trading_ledger import (
    TradingLedger,
    TurnoverConvention,
...
- 当前教学 notebook：`notebooks/lower/ch08_ml_alpha_model.ipynb`、`notebooks/lower/ch12_ml_alpha_validation.ipynb`、`notebooks/lower/ch13_ml_alpha_research.ipynb`；历史整路线 oracle 仍由本模块兼容读取。
"""
