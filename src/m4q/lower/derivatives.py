...
- 当前教学 notebook：`notebooks/lower/ch14_derivatives_stochastic.ipynb`、`notebooks/lower/ch15_derivatives_numerics.ipynb`、`notebooks/lower/ch16_derivatives_hedging.ipynb`；历史整路线 oracle 仍由本模块兼容读取。
"""
